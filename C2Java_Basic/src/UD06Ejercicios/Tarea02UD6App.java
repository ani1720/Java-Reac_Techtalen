...
public class Tarea02UD6App {
	...
	public static void main(String[] args) {
		// System.out.println(Math.random()*100); operacion de aritmetica para hacer
		// random
		...
		/*
		 * creamos un bucle FOR donde le asignamos que el entero i es igual a numero
		 * random ingresado por el usuario decimos que i es mayor a 0 y que i se
		 * incremente
		 */
