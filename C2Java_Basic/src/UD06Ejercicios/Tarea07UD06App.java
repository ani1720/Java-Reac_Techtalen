...
public class Tarea07UD06App {
	...
	public static void main(String[] args) {
		...
		// Aplicamos un Try Catch para evitar un error al introducir un numero o algun
		// error
		try {
			euros = Double.parseDouble(input);
			JOptionPane.showMessageDialog(null, "Has introducido: " + euros + " euro");
		} catch (NumberFormatException e) {
			JOptionPane.showMessageDialog(null, "Por favor, introduce un numero valido.", "Error",
